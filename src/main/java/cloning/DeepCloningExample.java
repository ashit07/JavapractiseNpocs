...
public class DeepCloningExample implements Serializable {
  ...
  public DeepCloningExample(String ip, String deviceId, int seqNum) {
    super();
    this.ip = ip;
  ...
  /*
   * public void addExecutedDeviceCommandId(String id) { executedDeviceIds.add(id); }
   *
   * public String getExecutedDeviceCommandId() { return executedDeviceIds.poll(); }
   */
  @Override
  public String toString() {
    return "DeviceDetails [ip=" + ip + ", deviceId=" + deviceId + ", seqNum=" + seqNum
        + ", deviceAccessToken=" + deviceAccessToken + ", deviceIdToCommandIdMap"
        + deviceIdToCommandIdMap + ", id =" + id + ", command_id= " + command_id + "]";
  }
  ...
  public DeepCloningExample clone() {
    ...
    // this.seqNum);
    DeepCloningExample obj = (DeepCloningExample) deepClone(this);
    return obj;
  }
  ...
  public static void main(String[] args) {
    DeepCloningExample device = new DeepCloningExample("ip1", "id1", 1);
    ...
    DeepCloningExample cloned = device.clone();
