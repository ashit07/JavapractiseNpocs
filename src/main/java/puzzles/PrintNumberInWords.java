...
public class PrintNumberInWords {
  ...
  static public boolean HelperConvertNumberToText(int num, String[] result) {
    ...
    String[] strtens = {"Ten", "Twenty", "Thirty", "Fourty", "Fifty", "Sixty", "Seventy", "Eighty",
        "Ninety", "Hundred"};
  ...
  public static void main(String[] args) {
    ...
    int i, num;
    int[] arrNum =
        {-1, 0, 5, 10, 15, 19, 20, 21, 25, 33, 49, 50, 72, 99, 100, 101, 117, 199, 200, 214, 517,
            589, 999, 1000, 1010, 1018, 1200, 9890, 10119, 13535, 57019, 99999, 100000, 100001};
