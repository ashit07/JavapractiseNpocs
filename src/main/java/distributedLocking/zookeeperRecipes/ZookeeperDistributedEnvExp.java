package distributedLocking.zookeeperRecipes;
...
import distributedLocking.curatorRecipes.VerifierCuratorLockImpl;
...
public class ZookeeperDistributedEnvExp {
   ...
   * @throws Exception
   */
  public void usingCreateDeleteRetryZKNode()
  ...
  public void usingWriteAndReadDataZkNode()
      throws KeeperException, InterruptedException, Exception {
  ...
  // String name;
  //
  // public VerifierWriteLockImpl(String name, String path, CountDownLatch cd, List<String> dataCap)
  // throws Exception {
  // this.path = path;
  // this.cd= cd;
  ...
  // try {
  // Files.write(name.getBytes(), new
  // File("/Users/junas01/Documents/workspace/practise-java8/src/main/resources/abc.txt"));
  // } catch (IOException e) {
  // e.printStackTrace();
  // }
  // }
  ...
  // service.path("doc_type").accept(MediaType.APPLICATION_JSON).type("application/json").method("PATCH",
  // ClientResponse.class, mapping);
  //
