package distributedLocking.curatorRecipes;

import java.util.List;
import java.util.concurrent.CountDownLatch;
import org.apache.zookeeper.ZooKeeper;
import distributedLocking.zookeeperRecipes.ZookeeperDistributedEnvExp;
...
public class VerifierCuratorLockImpl implements Runnable {
  ...
  public VerifierCuratorLockImpl(String name, String path, CountDownLatch cd, List<String> dataCap)
      throws Exception {
    this.path = path;
    this.cd = cd;
